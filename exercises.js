...
console.log (moneyTrain(66));
console.log (moneyTrain(423))
...
function subways (special){
  for (var i =0; i < special.length; i++){
    if (i%2 === 1){
      console.log (i)
      subOftheDay.splice(i, 1, "Classic Tuna")
    }
  }
  return special
}
